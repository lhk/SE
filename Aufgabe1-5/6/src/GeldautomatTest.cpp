...
#include "GiroZinsen.h"
#include "TagesgeldZinsen.h"
#include "SparkontoZinsen.h"
...
GeldautomatTest::GeldautomatTest() :
		a(), k1(new SparkontoZinsen()), k2(new GiroZinsen()), k3(new TagesgeldZinsen()) {
}
...
void GeldautomatTest::zinsenAusdrucken1() {
	...
	a.zinsenAusdrucken();
	ASSERT_EQUAL(5, a.getGesamtZinsen());
...
void GeldautomatTest::zinsenAusdrucken3() {
	...
	a.zinsenAusdrucken();
	ASSERT_EQUAL(9, a.getGesamtZinsen());
}

void GeldautomatTest::zinsenAusdrucken4() {
	a.zinsenAusdrucken();
	ASSERT_EQUAL(0, a.getGesamtZinsen());
}
